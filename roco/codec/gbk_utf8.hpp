...
#ifndef _ROCO_CODEC_GBK_UTF8_HPP_
#define _ROCO_CODEC_GBK_UTF8_HPP_
...
#define COMPBYTE(x, y) ((unsigned char)(x) << 8 | (unsigned char)(y))
	...
	inline const unsigned short* _initTns()
	{
	...
	inline const unsigned short* _initGbk2utf16_2()
	{
	...
	inline const unsigned short* _initGbk2utf16_3()
	{
	...
	inline const unsigned short* _initTrad2Simp_utf16()
	{
	...
	inline const unsigned short* _initTrad2Simp_gbk()
	{
	...
	inline const unsigned short* _initPlain_utf16()
	{
	...
	inline const unsigned short* _initPlain_gbk()
	{
	...
	inline const char* _initUpper2Lower()
	{
	...
	inline const char* _initLower2Upper()
	{
	...
	inline const unsigned short* _initGbk2Utf16()
	{
	...
	inline const unsigned short* _initUtf162Gbk()
	{
	...
	inline void str_normalize_init()
	{
		_pTns = _initTns();
	...
	inline void str_normalize_gbk(char* text, unsigned options)
	{
	...
	inline void str_normalize_utf8(char* text, unsigned options)
	{
		const char* pTransTable =
			(options & SNO_TO_LOWER) ? _pUpper2Lower : (
				(options & SNO_TO_UPPER) ? _pLower2Upper :
	...
	inline int gbk_to_utf8(const char* from, unsigned int from_len, char** to, unsigned int* to_len)
	{
		char* result = *to;
		unsigned i_from = 0;
		unsigned i_to = 0;
	...
	inline int utf8_to_gbk(const char* from, unsigned int from_len, char** to, unsigned int* to_len)
	{
		char* result = *to;
		unsigned i_from = 0;
		unsigned i_to = 0;
...
#endif // _ROCO_CODEC_GBK_UTF8_HPP_